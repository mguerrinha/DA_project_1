//
// Created by miguel on 10-03-2024.
//

#ifndef DA_PROJECT_1_GRAPH_H
#define DA_PROJECT_1_GRAPH_H
#include <iostream>
#include <vector>
#include <queue>
#include <limits>
...
public:
    ...
    */
    ...
    bool addBidirectionalEdgeEdmond(const T &sourc, const T &dest, double w);
protected:
...
template <class T>
bool Graph<T>::addBidirectionalEdgeEdmond(const T &sourc, const T &dest, double w) {
    auto v1 = findVertex(sourc);
    auto v2 = findVertex(dest);
    if (v1 == nullptr || v2 == nullptr)
        return false;
